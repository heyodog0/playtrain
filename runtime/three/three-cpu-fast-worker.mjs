/**
 * three-cpu-fast IPC worker. Renders a STANDARD three.js scene on the CPU (Projector
...
import { ThreeCPUFastRenderer } from './three-cpu-fast.mjs';
...
const renderer = new ThreeCPUFastRenderer(opts.obsSize, opts.obsSize);
