// ===== cavequest_hard_explore_mono: all items pure white; only SHAPE distinguishes them =====
...
function getItemColor(vid) {
    ...
    if (vid === 6)  return color(255);
    if (vid === 7)  return color(255);
    if (vid === 17) return color(255);
    if (vid === 12) return color(255);
    if (vid === 14) return color(255);
