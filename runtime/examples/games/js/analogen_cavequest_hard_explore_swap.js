// ===== cavequest_hard_explore_swap: item shapes replaced (dungeon charms); colors kept =====
// Auto-derived from analogen_cavequest_hard_explore (env dynamics IDENTICAL);
// ONLY the item visuals are transformed, matching the cavequest_easy variants.
