// analogen_nomemory_grid_v5_2rooms_door_6x6_easy (same mechanics as v5_2rooms_door_6x6 — BLUE_KEY-locked door, key consumed on open — but with a 1x3 door spanning rows 2-4 at col 2, and a 2x6 goal region spanning cols 4-5 all rows. Makes the navigation phase maximally forgiving while preserving the binding-identification + key-consumption mechanics.)
...
function initRoom() {
    ...
    // 6x6_easy: door is 1x3 spanning col=2 rows=2-4 (was 1x1 at row=2),
    // goal is 2x6 spanning cols=4-5 all rows (was 1x1 at (5,0)). The
    // left room (cols 0-1) and the col-3 corridor on the right room are
    // unchanged. Random walk in the right room has ~67% chance of
    // landing on goal cells; door catchment along the wall is 3/6 = 50%.
    mapData = [
        [0,0,1,0,11,11],
        [0,0,1,0,11,11],
        [0,0,2,0,11,11],
