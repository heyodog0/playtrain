// coinrun, fast internal representation: the tile grid is a FLAT Uint8Array of
// integer tile-IDs (not a 2D array of strings). IDENTICAL gameplay/visuals/RNG —
// only the grid storage + classification changed. Bit-exact obs vs coinrun.js.
// ============================================================
