// ===== cavequest_hard_explore_recolor: item colors channel-permuted (shapes/world unchanged) =====
...
function getItemColor(vid) {
    ...
    if (vid === 6)  return color(100, 200, 255);
    if (vid === 7)  return color(170, 255, 80);
    if (vid === 17) return color(150, 60, 230);
    if (vid === 12) return color(255, 140, 0);
    if (vid === 14) return color(0, 255, 150);
    ...
    if (vid === 18) return color(200, 170, 0);
    return color(255);
}
