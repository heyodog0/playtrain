...
Craftax anywhere to be exact against. Its dynamics are the classic port's,
unchanged.
...
Built and gated. The one thing not measured is cluster throughput.
...
The design asked for **≥ 8,000 SPS/core** under QuickJS, budgeting
