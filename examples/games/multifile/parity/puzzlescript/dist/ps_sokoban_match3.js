// ps_sokoban_match3 — GENERATED by tools/bundle_puzzlescript.mjs, do not edit.
// reference: PuzzleScript d236596d993b (engine vendored verbatim, see manifest.json); game src/demo/sokoban_match3.txt sha256 fc268e570b9d
const PS_GAME_TEXT = "title Match 3 Block Push\nauthor increpare\nhomepage www.puzzlescript.net\n\n========\nOBJECTS\n========\n\nBackground\nlightgreen green\n11111\n01111\n11101\n11111\n10111\n\n\nTarget\ndarkblue\n.....\n.000.\n.0.0.\n.000.\n.....\n\nWall\nbrown darkbrown\n00010\n11111\n01000\n11111\n00010\n\nPlayer\nblack orange white blue\n.000.\n.111.\n22222\n.333.\n.3.3.\n\nCrate\norange yellow\n00000\n0...0\n0...0\n0...0\n00000\n\n\n=======\nLEGEND\n=======\n\n. = Background\n# = Wall\nP = Player\n* = Crate\n@ = Crate and Target\nO = Target\n\n\n=======\nSOUNDS\n=======\n\nCrate MOVE 36772507\n\n================\nCOLLISIONLAYERS\n================\n\nBackground\nTarget\nPlayer, Wall, Crate\n\n======\nRULES\n======\n\n[ >  Player | Crate ] -> [  >  Player | > Crate  ]\n\nlate [ Crate | Crate | Crate ] -> [ | | ]\n\n==============\nWINCONDITIONS\n==============\n\nall Crate on Target\n\n=======\nLEVELS\n=======\n\n#########\n#.......#\n#.*.*.@.#\n#.P...O.#\n#...*.*.#\n#.......#\n#########\n\n.#######.\n.#.....#.\n.#O##..##\n##.##.*.#\n#.*..**.#\n#.OOO.#.#\n#.P.....#\n#########\n";
const PS_GAME_DEF = {"game":"sokoban_match3","title":"Match 3 Block Push","author":"increpare","dropdown_group":"Tutorial","source":"src/demo/sokoban_match3.txt","sha256":"fc268e570b9d92011f3c47c0ec6082cd871619a3b6b9d320397920d29d862ee7","level_mode":"seed","playable_levels":[0,1],"levels":2,"metadata_keys":["title","author","homepage"],"human":{"controls":"Arrows move, SPACE acts. Match 3 Block Push by increpare: level = seed % 2 of the 2 playable levels; the episode ends when the level is solved."},"objects":5,"level_sizes":[[9,7],[9,8]],"symbolic":{"objects":5,"max_width":9,"max_height":8,"dim":360,"layout":"float32[objects][max_height][max_width]: 1 where the object is present in the cell (level.objects bit), cells outside the current level 0; the level is placed at the top-left"}};
