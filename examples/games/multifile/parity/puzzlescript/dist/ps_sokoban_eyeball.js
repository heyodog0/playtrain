// ps_sokoban_eyeball — GENERATED by tools/bundle_puzzlescript.mjs, do not edit.
// reference: PuzzleScript d236596d993b (engine vendored verbatim, see manifest.json); game src/demo/sokoban_eyeball.txt sha256 811e22e97ae3
const PS_GAME_TEXT = "title EYE EYE EYE\nauthor increpare\nhomepage www.puzzlescript.net\n\n========\nOBJECTS\n========\n\nBackground\nlightgreen green\n11111\n01111\n11101\n11111\n10111\n\nTarget\ndarkblue\n.....\n.000.\n.0.0.\n.000.\n.....\n\nWall\nbrown darkbrown\n00010\n11111\n01000\n11111\n00010\n\nPlayer\nblack orange white blue\n.000.\n.111.\n22222\n.333.\n.3.3.\n\nEyeBall\nwhite blue red\n.000.\n00100\n01110\n20102\n.202.\n\n=======\nLEGEND\n=======\n\n. = Background\n# = Wall\nP = Player\nO = EyeBall\n\n=======\nSOUNDS\n=======\n\nsfx0 67117309\n\n================\nCOLLISIONLAYERS\n================\n\nBackground\nTarget\nPlayer, Wall, EyeBall\n\n======\nRULES\n======\n\n[ Eyeball | ... | Player ] -> [ > Eyeball | ... | Player ] sfx0\n\n==============\nWINCONDITIONS\n==============\n\n(There's no way to win against a floating eyeball :S )\n\n=======\nLEVELS\n=======\n\n#########\n#.......#\n#....O..#\n#.P.....#\n#.......#\n#.......#\n#########\n";
const PS_GAME_DEF = {"game":"sokoban_eyeball","title":"EYE EYE EYE","author":"increpare","dropdown_group":"Tutorial","source":"src/demo/sokoban_eyeball.txt","sha256":"811e22e97ae3cfc1d0349cf52f7181b14c04cb19a82e7f00d5404196a5aa0dd8","level_mode":"seed","playable_levels":[0],"levels":1,"metadata_keys":["title","author","homepage"],"human":{"controls":"Arrows move, SPACE acts. EYE EYE EYE by increpare: level = seed % 1 of the 1 playable levels; the episode ends when the level is solved."},"objects":5,"level_sizes":[[9,7]],"symbolic":{"objects":5,"max_width":9,"max_height":7,"dim":315,"layout":"float32[objects][max_height][max_width]: 1 where the object is present in the cell (level.objects bit), cells outside the current level 0; the level is placed at the top-left"}};
