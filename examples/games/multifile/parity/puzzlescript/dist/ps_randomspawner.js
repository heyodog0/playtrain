// ps_randomspawner — GENERATED by tools/bundle_puzzlescript.mjs, do not edit.
// reference: PuzzleScript d236596d993b (engine vendored verbatim, see manifest.json); game src/demo/randomspawner.txt sha256 9520d1b66a06
const PS_GAME_TEXT = "title Robot Spawner\nauthor increpare\nhomepage www.puzzlescript.net\n\n========\nOBJECTS\n========\n\nBackground (special, automatically placed in its own layer)\ngreen darkgreen\n11111\n01111\n11101\n11111\n10111\n\nSpawner (Name)\nyellow \t(Color)\n..... \t(Sprite)\n..0..\n.000.\n..0..\n.....\n\nPlayer (Required by game)\npink\n..0..\n00000\n..0..\n.000.\n.0.0.\n\nRedRobot\ngray black red\n.000.\n.200.\n...0.\n00000\n01010\n\nGreenRobot\ngray black lightgreen\n.000.\n.200.\n...0.\n00000\n01010\n\nBlueRobot\ngray black lightblue\n.000.\n.200.\n...0.\n00000\n01010\n\n=======\nLEGEND\n=======\n\nRobot = RedRobot or GreenRobot or BlueRobot\nObstacle = Player or Robot\n. = Background\nP = Player\n* = Robot\nO = Spawner\n\n=========\nSOUNDS\n=========\n\n================\nCOLLISIONLAYERS\n================\n\nBackground\nSpawner\nPlayer, Robot\n\n======\nRULES\n======\n\n[ stationary Robot ] -> [ randomDir Robot ] \n[ Spawner no Obstacle ] -> [ Spawner random Robot ] \n\n==============\nWINCONDITIONS\n==============\n\n=======\nLEVELS\n=======\n\n.......\n.......\n.......\n...O...\n.......\n.P.....\n.......\n";
const PS_GAME_DEF = {"game":"randomspawner","title":"Robot Spawner","author":"increpare","dropdown_group":"Tutorial","source":"src/demo/randomspawner.txt","sha256":"9520d1b66a0641322dd113fe16bde23b67fc10299bef78dfadfe94a63569973e","level_mode":"seed","playable_levels":[0],"levels":1,"metadata_keys":["title","author","homepage"],"human":{"controls":"Arrows move, SPACE acts. Robot Spawner by increpare: level = seed % 1 of the 1 playable levels; the episode ends when the level is solved."},"objects":6,"level_sizes":[[7,7]],"symbolic":{"objects":6,"max_width":7,"max_height":7,"dim":294,"layout":"float32[objects][max_height][max_width]: 1 where the object is present in the cell (level.objects bit), cells outside the current level 0; the level is placed at the top-left"}};
