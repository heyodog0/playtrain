// ps_notsnake — GENERATED by tools/bundle_puzzlescript.mjs, do not edit.
// reference: PuzzleScript d236596d993b (engine vendored verbatim, see manifest.json); game src/demo/notsnake.txt sha256 b9e4dfb30e6d
const PS_GAME_TEXT = "title Notsnake\nauthor Terry Cavanagh\nhomepage www.distractionware.com\n\ncolor_palette c64\nrequire_player_movement\n\n========\nOBJECTS\n========\n\nBackground\nblue\n\nPlayer\nlightblue\n\nTrail\npurple\n\n=======\nLEGEND\n=======\n\n. = Background\nP = Player\nO = Trail\n\n=======\nSOUNDS\n=======\n\nstartgame 50287705\nsfx0 660507\nsfx1 41058704\nendgame 74955903\n\n================\nCOLLISIONLAYERS\n================\n\nBackground\nTrail\nPlayer\n\n======\nRULES\n======\n\n[ > Player | No Trail ] -> [ Trail | Player ] sfx0\n[ > Player | Trail ] -> [ | Player ] sfx1\n\n==============\nWINCONDITIONS\n==============\n\nno Trail\n\n=======\nLEVELS\n=======\n\nOOOOOOOO\nOOOOOOOO\nO..POO.O\nOOOOOOOO\nOOOOOOOO\n";
const PS_GAME_DEF = {"game":"notsnake","title":"Notsnake","author":"Terry Cavanagh","dropdown_group":"Elementary","source":"src/demo/notsnake.txt","sha256":"b9e4dfb30e6d92583ca42e2a858b2db0842caec88fee7bd9963d73acd08559d6","level_mode":"seed","playable_levels":[0],"levels":1,"metadata_keys":["title","author","homepage","color_palette","require_player_movement"],"human":{"controls":"Arrows move, SPACE acts. Notsnake by Terry Cavanagh: level = seed % 1 of the 1 playable levels; the episode ends when the level is solved."},"objects":3,"level_sizes":[[8,5]],"symbolic":{"objects":3,"max_width":8,"max_height":5,"dim":120,"layout":"float32[objects][max_height][max_width]: 1 where the object is present in the cell (level.objects bit), cells outside the current level 0; the level is placed at the top-left"}};
