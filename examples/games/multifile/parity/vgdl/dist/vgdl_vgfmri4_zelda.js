...
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  ...
  function tick(keys) {
    ...
    if (rcLiveCount(t_goal) <= 0) { if (VG.time > VG.spriteBonusT) { VG.score += 5; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=goal win=true bonus=5
  }
  VG.tickImpl = tick;
};
