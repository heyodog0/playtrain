// vgdl/vgfmri_rcrl/vgfmri3_chase — GENERATED by tools/bundle_vgdl.mjs, do not edit.
...
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  ...
  function tick(keys) {
    ...
    if (rcLiveCount(t_scared) <= 0) { VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=scared win=true
  }
  VG.tickImpl = tick;
};
