// vgdl/vgfmri_rcrl/vgfmri3_lemmings — GENERATED by tools/bundle_vgdl.mjs, do not edit.
...
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  ...
  function tick(keys) {
    ...
    if ((rcLiveCount(t_entrance) + rcLiveCount(t_lemming)) === 0) { if (VG.time > VG.spriteBonusT) { VG.score += 10; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // MultiSpriteCounter stype1=entrance stype2=lemming limit=0 win=true bonus=10
  }
  VG.tickImpl = tick;
};
