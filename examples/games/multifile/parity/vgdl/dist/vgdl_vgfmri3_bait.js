// vgdl/vgfmri_rcrl/vgfmri3_bait — GENERATED by tools/bundle_vgdl.mjs, do not edit.
...
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  ...
  function tick(keys) {
    ...
    if (rcLiveCount(t_goal) <= 0) { if (VG.time > VG.spriteBonusT) { VG.score += 10; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=goal limit=0 win=true bonus=10
  }
  VG.tickImpl = tick;
};
