...
const VG_GROUP_ORDER = ["chaser2", "chaser1", "wall", "avatar", "box1", "forcefield", "box3", "box2"];
...
// ---- compiled tick: 8 types, 29 rules (tools/compile_vgdl.mjs, profile rcrl) ----
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  const T = VG.types;
  const t_chaser1 = T[0];   // chaser1 > Chaser
  const t_chaser2 = T[1];   // chaser2 > Chaser
  const t_wall = T[2];   // wall > Immovable (inert)
  const t_forcefield = T[3];   // forcefield > Passive
  const t_box1 = T[4];   // box1 > Passive
  const t_box2 = T[5];   // box2 > Passive
  const t_box3 = T[6];   // box3 > Passive
  const t_avatar = T[7];   // avatar > MovingAvatar
  const EFF = VG.rcEffects;
  function events() {
    const cache = {};
    const dead = new Set();
    ...
    while (again) {
      const nc = new Set();
      let g_avatar = null, g_chaser = null, g_box1 = null, g_box3 = null, g_box2 = null, g_forcefield = null, g_rand = null, g_missile = null, g_wall = null, g_mover = null, g_box = null;   // group snapshots, one lookup per stype per pass
      // avatar chaser > nothing
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_chaser || (g_chaser = rcGroupEntry("chaser", cache));
      ...
      // box1 box3 > nothing
      { const e1 = g_box1 || (g_box1 = rcGroupEntry("box1", cache)), l1 = e1.list;
        const e2 = g_box3 || (g_box3 = rcGroupEntry("box3", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // box2 forcefield > nothing
      { const e1 = g_box2 || (g_box2 = rcGroupEntry("box2", cache)), l1 = e1.list;
        const e2 = g_forcefield || (g_forcefield = rcGroupEntry("forcefield", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // avatar rand > nothing
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_rand || (g_rand = rcGroupEntry("rand", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // box3 chaser > changeScore value=1
      { const e1 = g_box3 || (g_box3 = rcGroupEntry("box3", cache)), l1 = e1.list;
        const e2 = g_chaser || (g_chaser = rcGroupEntry("chaser", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // missile avatar > killSprite
      { const e1 = g_missile || (g_missile = rcGroupEntry("missile", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // mover wall > stepBack
      { const e1 = g_mover || (g_mover = rcGroupEntry("mover", cache)), l1 = e1.list;
        const e2 = g_wall || (g_wall = rcGroupEntry("wall", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // box wall > stepBack
      { const e1 = g_box || (g_box = rcGroupEntry("box", cache)), l1 = e1.list;
        const e2 = g_wall || (g_wall = rcGroupEntry("wall", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // rand wall > stepBack
      { const e1 = g_rand || (g_rand = rcGroupEntry("rand", cache)), l1 = e1.list;
        const e2 = g_wall || (g_wall = rcGroupEntry("wall", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      { const e1 = g_box3 || (g_box3 = rcGroupEntry("box3", cache)), l1 = e1.list;
        ...
        g_avatar = null; g_chaser = null; g_box1 = null; g_box3 = null; g_box2 = null; g_forcefield = null; g_rand = null; g_missile = null; g_wall = null; g_mover = null; g_box = null;   // _updateCollisionDict may have invalidated snapshots
      }
      // box1 avatar > bounceForward
      { const e1 = g_box1 || (g_box1 = rcGroupEntry("box1", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
      ...
      // box1 box2 > stepBack
      { const e1 = g_box1 || (g_box1 = rcGroupEntry("box1", cache)), l1 = e1.list;
        const e2 = g_box2 || (g_box2 = rcGroupEntry("box2", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // box1 box1 > stepBack
      { const e1 = g_box1 || (g_box1 = rcGroupEntry("box1", cache)), l1 = e1.list;
        const e2 = g_box1 || (g_box1 = rcGroupEntry("box1", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // forcefield rand > stepBack
      { const e1 = g_forcefield || (g_forcefield = rcGroupEntry("forcefield", cache)), l1 = e1.list;
        const e2 = g_rand || (g_rand = rcGroupEntry("rand", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // chaser forcefield > stepBack
      { const e1 = g_chaser || (g_chaser = rcGroupEntry("chaser", cache)), l1 = e1.list;
        const e2 = g_forcefield || (g_forcefield = rcGroupEntry("forcefield", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // mover mover > stepBack
      { const e1 = g_mover || (g_mover = rcGroupEntry("mover", cache)), l1 = e1.list;
        const e2 = g_mover || (g_mover = rcGroupEntry("mover", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      // missile EOS > wrapAround
      { const e1 = g_missile || (g_missile = rcGroupEntry("missile", cache)), l1 = e1.list;
        for (let u = 0; u < l1.length; u += 2) { const s = l1[u], si = l1[u + 1]; if (!vgContains(s, si)) EFF[27].fn(s, si, null, -1, EFF[27].args); } }
      // missile missile > reverseDirection
      { const e1 = g_missile || (g_missile = rcGroupEntry("missile", cache)), l1 = e1.list;
        const e2 = g_missile || (g_missile = rcGroupEntry("missile", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
  ...
  function tick(keys) {
    ...
    const noop = keys !== null && keys.length === 0;
    VG.keys = keys || [];
    for (let k = 0; k < t_chaser1.n; k++) { const i = t_chaser1.live[k]; if (!t_chaser1.killed[i]) rcUpdChaser(t_chaser1, i); }   // chaser1 > Chaser
    for (let k = 0; k < t_chaser2.n; k++) { const i = t_chaser2.live[k]; if (!t_chaser2.killed[i]) rcUpdChaser(t_chaser2, i); }   // chaser2 > Chaser
    for (let k = 0; k < t_forcefield.n; k++) { const i = t_forcefield.live[k]; if (!t_forcefield.killed[i]) rcUpdBase(t_forcefield, i); }   // forcefield > Passive
    for (let k = 0; k < t_box1.n; k++) { const i = t_box1.live[k]; if (!t_box1.killed[i]) rcUpdBase(t_box1, i); }   // box1 > Passive
    for (let k = 0; k < t_box2.n; k++) { const i = t_box2.live[k]; if (!t_box2.killed[i]) rcUpdBase(t_box2, i); }   // box2 > Passive
    for (let k = 0; k < t_box3.n; k++) { const i = t_box3.live[k]; if (!t_box3.killed[i]) rcUpdBase(t_box3, i); }   // box3 > Passive
    for (let k = 0; k < t_avatar.n; k++) { const i = t_avatar.live[k]; if (!t_avatar.killed[i]) rcUpdMoving(t_avatar, i); }   // avatar > MovingAvatar
    events();
    rcFlush();
    VG.time += 1;
    // terminations in _isDone order
    VG.ended = false; VG.won = false;
    if (rcLiveCount(t_avatar) <= 0) { VG.ended = true; VG.won = false; return; }   // SpriteCounter stype=avatar limit=0 win=false
    if (rcLiveCount(t_box1) <= 0) { if (VG.time > VG.spriteBonusT) { VG.score += 5; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=box1 limit=0 win=true bonus=5
  }
  VG.tickImpl = tick;
};
