// vgdl/vgfmri_rcrl/vgfmri3_zelda — GENERATED by tools/bundle_vgdl.mjs, do not edit.
// reference: py-vgdl (see manifest.json); block=30 render=tiles levels=9
...
const VG_LEVELS = ["wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw.......g..w.................w\nw..........w.................w\nw.................w.......+..w\nw.....A...........w..........w\nw.................w..........w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw.......g..w.................w\nw..........w.................w\nw.................w.......+..w\nw...............A.w..........w\nw...3.............w..........w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw..3.......wg..........3.....w\nw............................w\nw............................w\nw............................w\nw...................w........w\nw...................w........w\nw..3.......w........w........w\nw..........w+.......w..A.....w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw..........wg................w\nw..........wwwww.............w\nw............................w\nw............................w\nw.......3....................w\nw............................w\nw............................w\nw.....................wwwwwwww\nw...........................+w\nw..........w.................w\nw..........w...........3.....w\nwA.........w.................w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw.........+w.............A...w\nw.......wwww.................w\nw............................w\nw.......2....................w\nw.................3..........w\nw............................w\nw............................w\nw.....................wwwwwwww\nw....2.......................w\nw.......wwww.................w\nw.........gw.................w\nw..........w.................w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw..........w.............A...w\nw.......wwww.................w\nw............................w\nw..........3.................w\nw............................w\nwwwwwww......................w\nw............................w\nw.....................wwwwwwww\nw....2................g......w\nw.......wwww.................w\nw.........+w...........1.....w\nw..........w.................w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwwwwwwwwwwwwwwwwwwww\nw..........w.................w\nw.........gw.............A...w\nw.......wwww.................w\nw............................w\nw..........3.................w\nw.....................wwwwwwww\nwwwwwww.....................+w\nw..................3.........w\nw...2........................w\nw............................w\nw.......wwww.................w\nw.......2..w...........1.....w\nw..........w.................w\nwwwwwwwwwwwwwwwwwwwwwwwwwwwwww","wwwwwwwwwwwww\nwA.......w..w\nw..w........w\nw...w...w.+ww\nwww.w2..wwwww\nw.......w.g.w\nw.2.........w\nw.....2.....w\nwwwwwwwwwwwww\n","wwwwwwwwwwwww\nw.3.gw....1.w\nw..www......w\nw..........2w\nw.......wwwww\nw.......w+..w\nw...w...w...w\nwA..w.......w\nwwwwwwwwwwwww\n"];
const VG_BLOCK = 30;
const VG_LEVEL_MODE = "seed";
const VG_LEVEL_INDEX = 0;
const VG_RENDER = "tiles";
const VG_PROFILE = "rcrl";
const VG_GROUP_ORDER = ["key", "goal", "wall", "monsterNormal", "avatar", "sword", "monsterSlow", "monsterQuick"];
...
// ---- compiled tick: 8 types, 35 rules (tools/compile_vgdl.mjs, profile rcrl) ----
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  const T = VG.types;
  const t_goal = T[0];   // goal > Immovable (inert)
  const t_key = T[1];   // key > Resource
  const t_sword = T[2];   // sword > OrientedFlicker
  const t_monsterQuick = T[3];   // monsterQuick > RandomNPC
  const t_monsterNormal = T[4];   // monsterNormal > RandomNPC
  const t_monsterSlow = T[5];   // monsterSlow > RandomNPC
  const t_wall = T[6];   // wall > Immovable (inert)
  const t_avatar = T[7];   // avatar > ShootAvatar
  const EFF = VG.rcEffects;
  function events() {
    const cache = {};
    const dead = new Set();
    for (let k = 0; k < VG.killList.length; k += 2) dead.add(rcSpriteKey(VG.types[VG.killList[k]], VG.killList[k + 1]));
    const collisionSet = new Set(), force = [];
    let again = true;
    while (again) {
      const nc = new Set();
      let g_avatar = null, g_goal = null, g_monsterSlow = null, g_key = null, g_monsterQuick = null, g_monsterNormal = null, g_sword = null, g_wall = null;   // group snapshots, one lookup per stype per pass
      // avatar goal > nothing
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_goal || (g_goal = rcGroupEntry("goal", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[0], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[0], EFF[0].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow key > nothing
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[1], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[1], EFF[1].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick key > nothing
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[2], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[2], EFF[2].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterNormal key > nothing
      { const e1 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[3], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[3], EFF[3].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // sword goal > nothing
      { const e1 = g_sword || (g_sword = rcGroupEntry("sword", cache)), l1 = e1.list;
        const e2 = g_goal || (g_goal = rcGroupEntry("goal", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[4], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[4], EFF[4].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // sword key > nothing
      { const e1 = g_sword || (g_sword = rcGroupEntry("sword", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[5], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[5], EFF[5].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // sword wall > nothing
      { const e1 = g_sword || (g_sword = rcGroupEntry("sword", cache)), l1 = e1.list;
        const e2 = g_wall || (g_wall = rcGroupEntry("wall", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[6], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[6], EFF[6].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // sword avatar > nothing
      { const e1 = g_sword || (g_sword = rcGroupEntry("sword", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[7], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[7], EFF[7].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // sword sword > nothing
      { const e1 = g_sword || (g_sword = rcGroupEntry("sword", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[8], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[8], EFF[8].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow sword > changeScore value=2
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[9], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[9], EFF[9].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick sword > changeScore value=2
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[10], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[10], EFF[10].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterNormal sword > changeScore value=2
      { const e1 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[11], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[11], EFF[11].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar key > changeResource resource=key value=1
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[12], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[12], EFF[12].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar key > changeScore value=1
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_key || (g_key = rcGroupEntry("key", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[13], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[13], EFF[13].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterSlow > changeScore value=-1
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[14], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[14], EFF[14].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterQuick > changeScore value=-1
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[15], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[15], EFF[15].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterNormal > changeScore value=-1
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[16], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[16], EFF[16].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // goal avatar > killIfOtherHasMore resource=key limit=1
      { const e1 = g_goal || (g_goal = rcGroupEntry("goal", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[17], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[17], EFF[17].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow sword > killSprite
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[18], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[18], EFF[18].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick sword > killSprite
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[19], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[19], EFF[19].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterNormal sword > killSprite
      { const e1 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache)), l1 = e1.list;
        const e2 = g_sword || (g_sword = rcGroupEntry("sword", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[20], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[20], EFF[20].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterSlow > killSprite
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[21], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[21], EFF[21].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterQuick > killSprite
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[22], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[22], EFF[22].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar monsterNormal > killSprite
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        const e2 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[23], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[23], EFF[23].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // key avatar > killSprite
      { const e1 = g_key || (g_key = rcGroupEntry("key", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[24], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[24], EFF[24].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // avatar wall > stepBack
      { const e1 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[25], EFF[25].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow monsterSlow > stepBack
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[26], EFF[26].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow monsterQuick > stepBack
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[27], EFF[27].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow monsterNormal > stepBack
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[28], EFF[28].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick monsterNormal > stepBack
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[29], EFF[29].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterNormal monsterNormal > stepBack
      { const e1 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[30], EFF[30].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick monsterQuick > stepBack
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[31], EFF[31].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterQuick wall > stepBack
      { const e1 = g_monsterQuick || (g_monsterQuick = rcGroupEntry("monsterQuick", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[32], EFF[32].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterNormal wall > stepBack
      { const e1 = g_monsterNormal || (g_monsterNormal = rcGroupEntry("monsterNormal", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[33], EFF[33].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      // monsterSlow wall > stepBack
      { const e1 = g_monsterSlow || (g_monsterSlow = rcGroupEntry("monsterSlow", cache)), l1 = e1.list;
        ...
        if (l1.length !== 0 && e2.list.length !== 0) {
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
            for (let v = 0; v < cand.length; v += 2) rcApplyPair(EFF[34], EFF[34].fn, 0, s1, i1, cand[v], cand[v + 1], dead, collisionSet, nc, force, cache); }
        }
      }
      for (const pk of nc) collisionSet.add(pk);
      again = nc.size > 0;
    }
  }
  function tick(keys) {
    ...
    const noop = keys !== null && keys.length === 0;
    VG.keys = keys || [];
    for (let k = 0; k < t_key.n; k++) { const i = t_key.live[k]; if (!t_key.killed[i]) rcUpdBase(t_key, i); }   // key > Resource
    for (let k = 0; k < t_sword.n; k++) { const i = t_sword.live[k]; if (!t_sword.killed[i]) rcUpdFlicker(t_sword, i); }   // sword > OrientedFlicker
    for (let k = 0; k < t_monsterQuick.n; k++) { const i = t_monsterQuick.live[k]; if (!t_monsterQuick.killed[i]) rcUpdRandom(t_monsterQuick, i); }   // monsterQuick > RandomNPC
    for (let k = 0; k < t_monsterNormal.n; k++) { const i = t_monsterNormal.live[k]; if (!t_monsterNormal.killed[i]) rcUpdRandom(t_monsterNormal, i); }   // monsterNormal > RandomNPC
    for (let k = 0; k < t_monsterSlow.n; k++) { const i = t_monsterSlow.live[k]; if (!t_monsterSlow.killed[i]) rcUpdRandom(t_monsterSlow, i); }   // monsterSlow > RandomNPC
    for (let k = 0; k < t_avatar.n; k++) { const i = t_avatar.live[k]; if (!t_avatar.killed[i]) rcUpdShoot(t_avatar, i); }   // avatar > ShootAvatar
    events();
    rcFlush();
    VG.time += 1;
    // terminations in _isDone order
    VG.ended = false; VG.won = false;
    if (rcLiveCount(t_avatar) <= 0) { VG.ended = true; VG.won = false; return; }   // SpriteCounter stype=avatar win=false
    if (rcLiveCount(t_goal) <= 0) { if (VG.time > VG.spriteBonusT) { VG.score += 10; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=goal win=true bonus=10
  }
  VG.tickImpl = tick;
};
