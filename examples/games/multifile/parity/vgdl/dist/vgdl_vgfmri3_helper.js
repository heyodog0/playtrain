// vgdl/vgfmri_rcrl/vgfmri3_helper — GENERATED by tools/bundle_vgdl.mjs, do not edit.
...
// ---- compiled tick: 8 types, 27 rules (tools/compile_vgdl.mjs, profile rcrl) ----
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  ...
  function events() {
    ...
    while (again) {
      ...
      // missile EOS > wrapAround
      { const e1 = g_missile || (g_missile = rcGroupEntry("missile", cache)), l1 = e1.list;
        for (let u = 0; u < l1.length; u += 2) { const s = l1[u], si = l1[u + 1]; if (!vgContains(s, si)) EFF[25].fn(s, si, null, -1, EFF[25].args); } }
      // missile missile > reverseDirection
      { const e1 = g_missile || (g_missile = rcGroupEntry("missile", cache)), l1 = e1.list;
  ...
  function tick(keys) {
    ...
    if (rcLiveCount(t_box1) <= 0) { VG.ended = true; VG.won = true; return; }   // SpriteCounter stype=box1 limit=0 win=true
  }
  VG.tickImpl = tick;
};
