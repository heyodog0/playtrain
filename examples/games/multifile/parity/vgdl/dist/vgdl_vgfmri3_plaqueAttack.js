...
const VG_GROUP_ORDER = ["burger", "wall", "fullMolarSup", "deadMolarInf", "fluor", "burgerhole", "hotdoghole", "fullMolarInf", "hotdog", "deadMolarSup", "avatar"];
...
// ---- compiled tick: 11 types, 28 rules (tools/compile_vgdl.mjs, profile rcrl) ----
VG.installCompiled = function () {   // called by vgPrepare once the type table is resolved
  const T = VG.types;
  const t_fullMolarInf = T[0];   // fullMolarInf > Immovable (inert)
  const t_fullMolarSup = T[1];   // fullMolarSup > Immovable (inert)
  const t_deadMolarInf = T[2];   // deadMolarInf > Immovable (inert)
  const t_deadMolarSup = T[3];   // deadMolarSup > Immovable (inert)
  const t_hotdog = T[4];   // hotdog > Chaser
  const t_burger = T[5];   // burger > Chaser
  const t_hotdoghole = T[6];   // hotdoghole > SpawnPoint
  const t_burgerhole = T[7];   // burgerhole > SpawnPoint
  const t_fluor = T[8];   // fluor > Missile
  const t_wall = T[9];   // wall > Immovable (inert)
  const t_avatar = T[10];   // avatar > ShootAvatar
  const EFF = VG.rcEffects;
  function events() {
    const cache = {};
    const dead = new Set();
    ...
    while (again) {
      const nc = new Set();
      let g_fluor = null, g_hotdog = null, g_burger = null, g_deadMolarInf = null, g_avatar = null, g_deadMolarSup = null, g_fullMolarInf = null, g_fullMolarSup = null, g_wall = null;   // group snapshots, one lookup per stype per pass
      // fluor hotdog > changeScore value=1
      { const e1 = g_fluor || (g_fluor = rcGroupEntry("fluor", cache)), l1 = e1.list;
        const e2 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache));
      ...
      // hotdog fluor > changeScore value=1
      { const e1 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache)), l1 = e1.list;
        const e2 = g_fluor || (g_fluor = rcGroupEntry("fluor", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // fluor burger > changeScore value=1
      { const e1 = g_fluor || (g_fluor = rcGroupEntry("fluor", cache)), l1 = e1.list;
        const e2 = g_burger || (g_burger = rcGroupEntry("burger", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // burger fluor > changeScore value=1
      { const e1 = g_burger || (g_burger = rcGroupEntry("burger", cache)), l1 = e1.list;
        const e2 = g_fluor || (g_fluor = rcGroupEntry("fluor", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // deadMolarInf avatar > changeScore value=1
      { const e1 = g_deadMolarInf || (g_deadMolarInf = rcGroupEntry("deadMolarInf", cache)), l1 = e1.list;
      ...
      // deadMolarSup avatar > changeScore value=1
      { const e1 = g_deadMolarSup || (g_deadMolarSup = rcGroupEntry("deadMolarSup", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // fullMolarInf hotdog > changeScore value=-3
      { const e1 = g_fullMolarInf || (g_fullMolarInf = rcGroupEntry("fullMolarInf", cache)), l1 = e1.list;
        const e2 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // fullMolarSup hotdog > changeScore value=-3
      { const e1 = g_fullMolarSup || (g_fullMolarSup = rcGroupEntry("fullMolarSup", cache)), l1 = e1.list;
        const e2 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // hotdog fullMolarInf > killSprite
      { const e1 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache)), l1 = e1.list;
        const e2 = g_fullMolarInf || (g_fullMolarInf = rcGroupEntry("fullMolarInf", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      // hotdog fullMolarSup > killSprite
      { const e1 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache)), l1 = e1.list;
        const e2 = g_fullMolarSup || (g_fullMolarSup = rcGroupEntry("fullMolarSup", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
      ...
      { const e1 = g_fullMolarSup || (g_fullMolarSup = rcGroupEntry("fullMolarSup", cache)), l1 = e1.list;
        const e2 = g_hotdog || (g_hotdog = rcGroupEntry("hotdog", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[25], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      { const e1 = g_fullMolarSup || (g_fullMolarSup = rcGroupEntry("fullMolarSup", cache)), l1 = e1.list;
        const e2 = g_burger || (g_burger = rcGroupEntry("burger", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[26], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
      ...
      { const e1 = g_deadMolarSup || (g_deadMolarSup = rcGroupEntry("deadMolarSup", cache)), l1 = e1.list;
        const e2 = g_avatar || (g_avatar = rcGroupEntry("avatar", cache));
        if (l1.length !== 0 && e2.list.length !== 0) {
          if (l1.length > 4 * e2.list.length) rcRuleSmallSide(EFF[27], 0, e1, e2, dead, collisionSet, nc, force, cache); else
          for (let u = 0; u < l1.length; u += 2) { const s1 = l1[u], i1 = l1[u + 1]; rcCollect(s1, i1, e2); if (rcCand.length === 0) continue; const cand = rcCand.slice();
  ...
  function tick(keys) {
    ...
    const noop = keys !== null && keys.length === 0;
    VG.keys = keys || [];
    for (let k = 0; k < t_hotdog.n; k++) { const i = t_hotdog.live[k]; if (!t_hotdog.killed[i]) rcUpdChaser(t_hotdog, i); }   // hotdog > Chaser
    for (let k = 0; k < t_burger.n; k++) { const i = t_burger.live[k]; if (!t_burger.killed[i]) rcUpdChaser(t_burger, i); }   // burger > Chaser
    for (let k = 0; k < t_hotdoghole.n; k++) { const i = t_hotdoghole.live[k]; if (!t_hotdoghole.killed[i]) rcUpdSpawn(t_hotdoghole, i); }   // hotdoghole > SpawnPoint
    for (let k = 0; k < t_burgerhole.n; k++) { const i = t_burgerhole.live[k]; if (!t_burgerhole.killed[i]) rcUpdSpawn(t_burgerhole, i); }   // burgerhole > SpawnPoint
    for (let k = 0; k < t_fluor.n; k++) { const i = t_fluor.live[k]; if (!t_fluor.killed[i]) rcUpdBase(t_fluor, i); }   // fluor > Missile
    ...
    VG.ended = false; VG.won = false;
    if ((rcLiveCount(t_fullMolarInf) + rcLiveCount(t_fullMolarSup)) === 0) { VG.ended = true; VG.won = false; return; }   // MultiSpriteCounter stype1=fullMolarInf stype2=fullMolarSup limit=0 win=false
    if ((rcLiveCount(t_hotdoghole) + rcLiveCount(t_hotdog) + rcLiveCount(t_burger) + rcLiveCount(t_burgerhole)) === 0) { if (VG.time > VG.spriteBonusT) { VG.score += 10; VG.spriteBonusT = VG.time; } VG.ended = true; VG.won = true; return; }   // MultiSpriteCounter stype1=hotdoghole stype2=hotdog stype3=burger stype4=burgerhole limit=0 win=true bonus=10
  }
  VG.tickImpl = tick;
};
