...
def _(mo):
    ...
    | MDP piece | What it means in `fast-llm-games` breakout |
    |---|---|
...
def _(mo):
    ...
    The single-game training entry point is [`src/fast_games/train/ppo.py`](/Users/heyodogo/code/lab/fast-llm-games/src/fast_games/train/ppo.py).
