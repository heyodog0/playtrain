...
//
// tools/study-parity.sh establishes that the pure-JS rasterizer, the Rust rasterizer and the
...
//
//   node tools/study-browser-check.mjs
//   node tools/study-browser-check.mjs --steps 900 --seed 90000 --games asteroids,caveflyer
//   node tools/study-browser-check.mjs --engines chromium,webkit
//
...
console.log(`reference: node + pure-JS rasterizer (bit-equal to the Rust rasterizer and the ` +
            `QuickJS training backend per tools/study-parity.sh)\n`);
