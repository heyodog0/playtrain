// Vendored from v8/v8 tag 14.1.146 (the V8 inside node 25), src/base/ieee754.cc,
// with its four V8-internal includes replaced by v8shim.h. Math.sin/cos/acos/
// atan2 in the reference runtime are these functions; openlibm is 1 ULP off on
// about 1% of inputs, which native/gate_qjs.sh sees as a diverging game.
#include "v8shim.h"
