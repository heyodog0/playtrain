"""T5 (VGDL): NativeVecEnv on libtwin_vec and on libqjs_vec, same game, seeds and actions, autoreset on: identical
...
@pytest.mark.parametrize("game", ["vgdl_aliens", "vgdl_pushBoulders", "vgdl_vgfmri3_bait", "vgdl_vgfmri4_zelda"])
