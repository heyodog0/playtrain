...
function update(dt) {
  ...
  if (playerJumpTimer > 0) {
    ...
    player.position.x = lerp(player.position.x, playerTargetX, t);
    player.position.z = lerp(player.position.z, playerTargetZ, t);
  ...
  updateCamera(camera, player, dt, { distance: 6, height: 10, smoothing: 10, mode: CAMERA_FOLLOW_2D });
}
