...
games/threejs/ directory via node_gym.NodeGymThreeEnv.

Usage:
    uv run gym-gen-validate-three --all
    uv run gym-gen-validate-three --game ball_roller
"""
...
def main() -> int:
    args = parse_args()
    games = [args.game] if args.game else list_available_threejs_games(THREEJS_GAMES_DIR)
